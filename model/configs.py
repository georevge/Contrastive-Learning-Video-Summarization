...
save_dir = Path('/home/gevge/Downloads/PGL-SUM-CAP-Embedding_space/Summaries/exp23')
...
def get_config(parse=True, **optional_kwargs):
    ...
    parser.add_argument('--heads', type=int, default=2, help="Number of global heads for the attention module")

    # Train
    parser.add_argument('--n_epochs', type=int, default=300, help='Number of training epochs')
    parser.add_argument('--batch_size', type=int, default=15, help='Size of each batch in training')
