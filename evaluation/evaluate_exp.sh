...
for i in 0 1 2 3 4; do
  ...
  model_path="$exp_path/$dataset/models/split$i"
  python evaluation/compute_fscores.py --path $results_path --model_path $model_path --dataset $dataset --eval $eval_method
done
