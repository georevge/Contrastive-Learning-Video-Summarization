...
parser.add_argument("--path", type=str,
                    default='/home/gevge/Downloads/PGL-SUM-CAP-Embedding_space/Summaries/exp122/TVSum/results/split3',
...
for epoch in results:                       # for each epoch ...
    ...
    all_summaries = generate_summary(all_shot_bound, all_scores, all_number_of_shots)
